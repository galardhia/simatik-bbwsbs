...
<head>
    ...
    <title>Dashboard Admin APBN</title>
...
<div class="d-flex">
    ...
    <div class="flex-grow-1 p-4">
        <nav class="topbar">
            <h4 class="primary-text fw-bold fs-3">Selamat Datang di Dashboard Admin APBN</h4>
        </nav>
            ...
            <div class="container mt-4">
                ...
                <div class="card shadow-sm p-3 mb-3">
                    ...
                    <div class="primary-bg text-white p-3 rounded d-flex justify-content-between align-items-center">
                        <span class="fw-bold">Semua Aset TIK <p><h5>APBN</h5></p></span>
                        <span class="fw-bold"><h5>100%</h5></span>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm p-3">
                            ...
                            <div class="primary-bg text-white p-2 rounded d-flex justify-content-between align-items-center">
                                <span>Aset TIK APBN<p><h6 class="fw-bold">Baik</h6></p></span>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm p-3">
                            ...
                            <div class="primary-bg text-white p-2 rounded d-flex justify-content-between align-items-center">
                                <span>Aset TIK APBN<p><h6 class="fw-bold">Rusak Ringan</h6></p></span>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm p-3">
                            ...
                            <div class="primary-bg text-white p-2 rounded d-flex justify-content-between align-items-center">
                                <span>Aset TIK APBN<p><h6 class="fw-bold">Rusak Berat</h6></p></span>
